You are given an integer n. You need to construct an array of integers a1,a2,…,an
 such that the following conditions are satisfied: 1≤ai≤2⋅n for all i from 1 to n.
All elements of the array and the sums of adjacent elements are pairwise distinct.
In other words, among the numbers {a1,a2,…,an,a1+a2,a2+a3,…,an−1+an}, there should not be two
equal numbers.
Input
...
For each test case, output an array of length n
 that satisfies the condition of the problem. It can be shown that such an array always
